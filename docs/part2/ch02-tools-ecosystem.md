...
|--------|--------|----------------------|------|
| **ChatGPT** | OpenAI | GPT-5.6, GPT-5.6 mini/nano (o3·o4-mini는 순차 퇴역) | 2022.11 |
...
| **멀티모달** | 이미지 인식, DALL-E 통합(독립 API는 단종, ChatGPT 내 GPT로 제공), 음성 대화 |
...
| **유료 버전** | Google AI Plus ($4.99/월), AI Pro ($19.99/월), AI Ultra ($99.99·$199.99/월) |
...
|--------|------|------|---------------------------|
| **ChatGPT** | GPT-5.6 nano (제한) | Go $8 / Plus $20 / Pro $200/월 | 모델별 상이 |
| **Claude** | Sonnet 5 (제한) | Pro $20 / Max $100~200/월 | $3 / $15 (Sonnet 5) |
| **Gemini** | 3.6 Flash | $19.99/월 (AI Pro) | $1.25 / $10 (3.5 Pro) |
