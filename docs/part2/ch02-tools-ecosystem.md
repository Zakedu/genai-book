...
| 서비스 | 개발사 | 최신 모델 (2026년 2월) | 출시 |
|--------|--------|----------------------|------|
| **ChatGPT** | OpenAI | GPT-5, GPT-5.2, o3, o4-mini | 2022.11 |
| **Claude** | Anthropic | Claude Opus 4.6, Sonnet 4.6, Haiku 4.5 | 2023.03 |
| **Gemini** | Google | Gemini 2.5 Pro, Gemini 2.0 Flash | 2023.12 |
...
Claude Code는 터미널에서 직접 코딩 작업을 수행하는 에이전트 도구입니다. Pro 이상 플랜에서 사용 가능합니다.
...
|--------|------|------|---------------------------|
| **ChatGPT** | GPT-5.2 (제한) | Go $8 / Plus $20 / Pro $200/월 | 모델별 상이 |
