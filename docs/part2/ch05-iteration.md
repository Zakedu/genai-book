...
!!! tip "증강 모드가 반복 개선과 가장 밀접"
    이 장에서 배우는 반복 개선 방법론은 바로 **증강 모드**에서 가장 큰 효과를 발휘합니다. AI를 일방적 도구가 아닌 **사고의 파트너**로 활용할 때, 피드백 루프가 가장 풍부하게 작동합니다.
...
!!! warning "대리 모드의 주의점"
    대리 모드에서는 AI의 자율성이 높아지는 만큼 **인간의 감독**이 더 중요해집니다. AI가 독립적으로 행동할수록 중간 점검과 최종 검증에 더 많은 주의를 기울여야 합니다.
