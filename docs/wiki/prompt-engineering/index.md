...
!!! info "최종 수정일: 2026-02-21"

대형 언어 모델(LLM)의 능력을 최대한 활용하기 위한 체계적 학습 자료입니다. 프롬프트 엔지니어링의 기본부터 고급 기법까지, 2026년 2월 기준 최신 모델(GPT-5, Claude 4.6, Gemini 2.5 Pro)에 맞춰 작성되었습니다.
