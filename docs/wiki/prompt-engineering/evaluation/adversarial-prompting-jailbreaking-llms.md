...
| 모델 | 성공률 | 주요 방어 | 특징 |
|------|--------|----------|------|
| GPT-5.6 | 3-5% | 의도 감지, 다층 검증 | 강화된 분류기 |
| Claude Opus 4.8 | 1-3% | Constitutional AI | 거부 명확성 증가 |
...
**방어 기술 (2026)**:
- Claude Opus 4.8: 역할극 탐지 시스템 (99% 감지율)
- GPT-5.6: 의도 분석 알고리즘
...
Claude Opus 4.8와 GPT-5.6의 고급 의도 분류:
- 진정한 요청 vs 위장된 요청 구분
- 맥락 기반 위험도 계산
- 문화적 뉘앙스 이해 (한국어 특수성)
...
- **2026년 강건성**: GPT-5.6와 Claude Opus 4.8은 90% 이상의 jailbreak 시도 차단
