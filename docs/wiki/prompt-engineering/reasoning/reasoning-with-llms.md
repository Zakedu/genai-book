...
!!! warning "벤치마크 수치 주의"
    아래 점수·차트는 **개념 이해를 위한 예시**이며 특정 시점의 공식 벤치마크 실측값이 아닙니다. 실제 점수는 모델 세대와 평가셋(AIME·GPQA·FrontierMath 등)에 따라 크게 달라지므로, 최신 공식 리더보드를 확인하세요.
...
| 벤치마크 | 설명 | 난이도 | o3 | Claude Opus 4.8 |
|---------|------|--------|-----|-----------|
