...
컨텍스트 캐싱은 반복적으로 사용되는 긴 문서나 데이터를 캐시하여 API 호출 비용을 크게 절감합니다. Gemini 2.5 Pro, Claude Opus 4.8 등의 최신 모델에서 지원합니다.
...
**Claude**:
- Claude Opus 4.8: 캐시된 입력 토큰 90% 할인
- 캐시 생성: 입력 토큰 25% 비용
...
| **추천 모델** | Claude Opus 4.8, Gemini 2.5 Pro |
| **적용 시간** | 즉시 (API 설정) |
