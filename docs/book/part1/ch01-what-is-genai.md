...
| 모델 | 개발사 | 파라미터 수 |
|------|--------|-----------|
| GPT-5 | OpenAI | 추정 1조+ (계속 증가)[^1] |
| Claude 4.6 | Anthropic | 비공개[^2] |
| Gemini 2.5 Pro | Google | 비공개[^3] |
| Llama 4 | Meta | 비공개 (대규모) |
...
| 유형 | 입력 | 출력 | 대표 도구 |
|------|------|------|----------|
| **텍스트 생성** | 텍스트 | 텍스트 | GPT-5, Claude 4.6, Gemini 2.5 |
| **이미지 생성** | 텍스트 | 이미지 | DALL-E 3, Midjourney, Stable Diffusion |
| **음성 생성** | 텍스트 | 음성 | ElevenLabs, VALL-E |
| **영상 생성** | 텍스트 | 영상 | Sora, Runway Gen-3, Kling 3.0 |
| **음악 생성** | 텍스트 | 음악 | Suno, Udio |
| **멀티모달** | 텍스트+이미지+오디오 | 텍스트+이미지+오디오 | GPT-5, Gemini 2.5 Pro |

### 멀티모달 AI의 등장

!!! tip "멀티모달(Multimodal)"
    텍스트, 이미지, 음성, 비디오 등 **여러 형태의 데이터를 동시에 이해하고 생성**할 수 있는 AI입니다. 2024년 이후 모든 주요 플랫폼의 필수 기능이 되었습니다.
