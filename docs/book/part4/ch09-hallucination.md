...
AI 환각은 실제로 심각한 결과를 초래한 사례들이 있습니다. 2023년 이후 발생한 사례들을 통해 환각의 위험성을 구체적으로 이해할 수 있습니다. 현재 최고 성능 모델은 0.7% 수준의 환각률을 보이지만, 추론 특화 모델은 특정 벤치마크에서 33-48% 환각률을 보입니다.
...
| 질문 유형 | 예시 | 환각 위험 |
|----------|------|----------|
| 학습 이후 사건 | "2025-2026년 최신 사건" | 매우 높음 |
| 희귀한 주제 | "특정 소규모 마을의 역사" | 높음 |
| 비공개 정보 | "특정 기업의 내부 데이터" | 매우 높음 |
| 개인 정보 | "특정 인물의 상세 이력" | 높음 |
| 추론 기반 작업 | "복잡한 수학/과학 문제" (o3 기반) | 중간~높음 (33-48%) |
