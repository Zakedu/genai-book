...
| 서비스 | 개발사 | 최신 모델 | 출시 |
|--------|--------|----------|------|
| **ChatGPT** | OpenAI | GPT-5, GPT-5.2 | 2022.11 (시작) |
| **Claude** | Anthropic | Claude 4.6 Sonnet, Claude 4.5 Opus | 2023.03 (시작) |
| **Gemini** | Google DeepMind | Gemini 2.5 Pro, Gemini 2.0 Flash | 2023.12 (시작) |
...
| **개발사** | OpenAI |
| **무료 버전** | GPT-5.2 (제한적) |
| **유료 버전** | Plus ($20/월) - GPT-5.2, o3-mini / Pro ($200/월) - GPT-5, o3, Deep Research, Sora |
| **API** | 사용량 기반 과금 |
| **컨텍스트 윈도우** | 128K 토큰 (주요 모델) |
...
| **에이전트** | Deep Research, Operator로 자율 작업 수행 |
| **생태계** | Custom GPTs, Projects, Canvas 등 풍부한 확장 기능 |
| **사용자 기반** | 가장 많은 사용자 = 풍부한 활용 사례와 팁 |
| **멀티모달** | 이미지 인식, DALL-E 통합, Sora 동영상, 음성 대화 |
...
|------|------|
| **개발사** | Anthropic |
| **무료 버전** | Claude 4.5 Sonnet (일일 사용량 제한) |
| **유료 버전** | Pro ($20/월) / Max ($100/월) |
| **API** | 사용량 기반 과금 |
...
| **에이전트** | Computer Use, MCP로 도구 연동 및 자동화 |
| **글쓰기 품질** | 자연스럽고 세련된 문체 |
...
| **유료 버전** | Advanced ($19.99/월, Google One AI Premium) |
| **API** | Google AI Studio, Vertex AI |
| **컨텍스트 윈도우** | 1M 토큰 (Gemini 2.5 Pro), 2M 토큰 (Gemini 1.5 Pro) |

### 강점

| 강점 | 설명 |
|------|------|
| **Google 통합** | Gmail, Docs, Drive 등 Google 서비스 완벽 연동 |
| **실시간 검색** | Google 검색 엔진 직접 연동 |
| **에이전트** | Deep Research, Gems로 자율 작업 가능 |
| **멀티모달** | 텍스트, 이미지, 오디오, 비디오 동시 처리 |
| **긴 컨텍스트** | 최대 2M 토큰 (약 5,000페이지) |
...
|--------|------|------|---------------------------|
| **ChatGPT** | GPT-5.2 (제한) | $20/월 (Plus) / $200/월 (Pro) | 변동 (GPT-5) |
| **Claude** | Claude 4.5 (제한) | $20/월 (Pro) / $100/월 (Max) | $3-5 / $15-25 |
| **Gemini** | 2.0 Flash | $19.99/월 (Advanced) | $0.10-1.25 / $0.40-10 |
...
| **Mistral** | Mistral AI | 경량화된 모델, 유럽 기반 |
